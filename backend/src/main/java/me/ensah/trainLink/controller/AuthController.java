...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RequestBody AuthRequest request) {
        // STEP 1: Extract email and password from request body (JSON automatically
        // converted to AuthRequest object)
        ...
        // STEP 4: Return token + user info in response (AuthResponse will be converted
        // to JSON)
        // Response:
        // {"token":"eyJ...","userId":1,"name":"John","email":"john@test.com","role":"admin"}
        return ResponseEntity.ok(new AuthResponse(
                token,
                user.getId(),
                user.getName(),
