...
public class RegisterController {
    ...
    public void initialize() {
        toLoginLink.setOnAction(e -> Navigation.goTo(stage(), "/fxml/LoginView.fxml"));
        updateHeaderButtons();
    }
    ...
    public void onSubmit() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                Platform.runLater(() -> Navigation.goTo(stage(), "/fxml/MainView.fxml"));
            } catch (Exception ex) {
    ...
    @FXML
    public void goLogin() { Navigation.goTo(stage(), "/fxml/LoginView.fxml"); }

    @FXML
    public void goHome() { Navigation.goTo(stage(), "/fxml/MainView.fxml"); }
